...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df = filtered_df.groupby(['Launch Site', 'class']).size().rest_index(name = 'counts')
        fig = px.pie(filtered_df, values='counts', names='class', title='Launch Success Rate For ' + entered_site)
        return fig
...
def get_scatter_chart(entered_site, payload):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.scatter(filtered_df[filtered_df['Launch Site'] == entered_site],x='Payload Mass (kg)', y='class',color='Booster Version Category',title='Payload vs Success for ' + entered_site)
        return fig
